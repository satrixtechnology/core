...
{
    const CONFIG_MODULE_PATH = 'satrixtech';
    ...
    */
    ...
    public function getModuleConfig($field = '', $storeId = null)
    {
        ...
        return $this->getConfigValue(self::CONFIG_MODULE_PATH . $field, $storeId);
    }
    ...
    {
        try {
            $decodeValue = $this->getJsonHelper()->jsonDecode($encodedValue);
        } catch (Exception $e) {
            $decodeValue = [];
        }
